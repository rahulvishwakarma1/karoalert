...
const startCallDeduction = (callId, callerUserId, client, callerSid, ownerSid, maxSeconds, activeDeductions) => {
      ...
      try {
        ...
        if (remainingSec > 0) {
          ...
          if (TWILIO_ACCOUNT_SID && TWILIO_AUTH_TOKEN) {
            ...
            startCallDeduction(callId, call.caller_user_id, twilioClient, call.twilio_call_sid, call.owner_twilio_call_sid, remainingSec, activeDeductions);
          }
        }
